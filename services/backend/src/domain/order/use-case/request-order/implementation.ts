...
import type { RequestOrderDTO } from '~backend/domain/order/dto';
...
export type Payload = Omit<RequestOrderDTO, 'state'>;
type Return = IResult<Order> | AppErrorUnexpected;

export class RequestOrderUseCase implements UseCase<Payload, Promise<Return>> {
