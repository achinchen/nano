      ...
      <section className={`${SECTION_CLASSNAMES} text-sm`}>
        <ul className="flex flex-col gap-2">
          <li className="flex items-center">
            <Field icon="i-solar-user-circle-linear">{i.info.name}</Field>
            {info.name}
          </li>
          <li className="flex items-center">
            <Field icon="i-solar-letter-linear">{i.info.email}</Field>
            {info.email}
          </li>
          <li className="flex items-center">
            <Field icon="i-solar-phone-calling-outline">{i.info.phone}</Field>
            {info.phone}
          </li>
          <li className="flex items-center">
            <Field icon="i-solar-camera-square-linear">{i.info.SNSId}</Field>
            {info.SNSId}
          </li>
        </ul>
        <Separator />
        <div>
          <Field icon="i-solar-chat-line-linear">{i.info.note}</Field>
