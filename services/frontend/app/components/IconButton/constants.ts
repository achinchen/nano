...
export const THEME_CONFIG: ThemeConfig = {
  ...
  dark: {
    ...
    outline: `border-zinc-500 color-zinc-700 active:color-zinc-900 active:border-zinc-500 active:bg-zinc-900 active:bg-opacity-20 hover:color-zinc-800 hover:border-zinc-500 hover:bg-zinc-800 hover:bg-opacity-5 disabled:border-zinc-200 disabled:color-zinc-200 ${OUTLINE_CLASS_NAME}`,
